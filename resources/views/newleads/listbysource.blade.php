    ...
    @else
        ...
        @foreach($countBysources as $source)
            ...
            <div class="col-lg-3 col-md-3 col-12  box" >  <a href="{{route('leads.details.bysources',[$date1,$date2,$source->source])}}"  >  <i class="fas fa-bullhorn"></i>
                ...
                @if ( $source->source <>  null  )
                    ...
                    @if ( $source->countsofleads <> 0 )
                        <div style="margin: 4px 0 2px 0 ; color:#286090   ">
                            {{$source->countsofleads }} New Leads
                        </div>
