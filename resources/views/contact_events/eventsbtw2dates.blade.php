            ...
            <div class="col-md-12">
                <div class="card" style="border:none">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <div class="row" >
                            <div class="col-12"><h2 class="d-flex justify-content-center">List of Contact Events between  2 dates </h2></div>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            $("#getdata").click(function () {
                ...
                searchurl = "{{route('contactEvents.contactEvent.list.btwdates.offices')}}"
                $.ajax({
                    type: "POST",
                    dataType: "html",
                    url: searchurl,
