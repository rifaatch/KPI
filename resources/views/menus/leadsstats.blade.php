                ...
                <div class="card" style="border:none">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-12  box"><a
                                        href="{{route('leads.bysources')}}"> <br><i
                                            class="fas fa-building"></i> New leads by Sources between 2 dates </a></div>

                            <div class="col-lg-3 col-md-3 col-12  box"><br> <a
                                        href="{{route('LeadEvents.LeadEvent.list.btwdates.offices')}}"> <i
                                            class="fas fa-bolt"></i> Leads Events Between 2 dates</a></div>
                            <div class="col-lg-3 col-md-3 col-12  box"><br> <a
