                            ...
                            <div class="row" >
                                <div class="col-12">
                                    <h2 class="d-flex justify-content-center">
                                        List of Application Events between 2 dates done by Employee:
                                    </h2></div>
                            </div>
                           ...
                           <div class=" row form-group ">
                            ...
                            <div id="htmdata">
                                @if (  $selectedEmployee && $date1<>null && $date2 <> null )
                                    ...
                                    @include ('application_events.listofevents' ,[ $applicationEvents ])
    ...
    <script>
        $(document).ready(function () {
            $("#getdata").click(function () {
                ...
                searchurl = "{{route('appEvents.btwdates.employee.details.submit')}}"
                $.ajax({
                    type: "POST",
                    dataType: "html",
                    url: searchurl,
