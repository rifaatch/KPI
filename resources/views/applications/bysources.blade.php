        ...
        <div class="row h-100 justify-content-center">
            <div class="col-md-12">
                <div class="card" style="border:none">
                    <div class="row" >
                        <div class="col-12"><h2 class="d-flex justify-content-center">New Applications by Sources between 2 dates </h2></div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            $("#getdata").click(function () {
                ...
                searchurl = "{{route('applications.group.bysources')}}"
                $.ajax({
                    type: "POST",
                    dataType: "html",
                    url: searchurl,
